...
# Lista unificada de origens permitidas
ALLOWED_ORIGINS = [
    "http://localhost:5173",
    "http://127.0.0.1:5173",
    "http://192.168.0.135:5173",
    "http://10.92.3.167:5173",
    "http://10.92.3.158:5173",
    "http://10.92.3.152:5173",
...
# Configurar Socket.IO para o ambiente Windows com simple-websocket
socketio = SocketIO(
    app,
...
os.makedirs(os.path.join(app.config['UPLOAD_FOLDER'], 'Pix'), exist_ok=True)
...
if __name__ == '__main__':
    ...
    # allow_unsafe_werkzeug=True adicionado para permitir a execução local no Windows
    socketio.run(
        app,
        host='0.0.0.0',
        port=5000,
